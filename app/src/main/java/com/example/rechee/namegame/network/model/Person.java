...
public class Person implements Parcelable {
    ...
    private final SocialLink[] socialLinks;
    ...
    private Person(Parcel in) {
        ...
        this.socialLinks = in.createTypedArray(SocialLink.CREATOR);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeTypedArray(this.socialLinks, flags);
    }
